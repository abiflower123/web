...
import { Award, Users, Code, BookOpen, Brain, TrendingUp, Zap, Target, CheckCircle, ArrowRight, Sparkles, Cpu, Eye, MessageSquare, Database, Shield } from 'lucide-react';
            ...
            {benefits.map((benefit, index) => (
              <AnimatedSection key={index} animation="scale" delay={index * 100}>
                <div className="group relative h-full">
                  <div className={`absolute -inset-3 bg-gradient-to-r ${benefit.color} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition-all duration-700 scale-95 group-hover:scale-100`} />
                  ...
                  <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 h-full flex flex-col border border-gray-100/50 dark:border-gray-700/50">
                    <div className="relative mb-6">
                      <div className={`absolute -inset-4 bg-gradient-to-r ${benefit.color} rounded-full blur-xl opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
                      <div className={`relative p-5 rounded-2xl bg-gradient-to-br ${benefit.color} text-white transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500`}>
                        {benefit.icon}
                      </div>
                    </div>
