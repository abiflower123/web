              ...
              >
                <AnimatedSection animation="scale" delay={index * 100}>
                  <div className="group relative h-full">
                    ...
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 h-full flex flex-col border border-gray-100 dark:border-gray-700 overflow-hidden">
                      {/* Icon with Animation */}
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-6">
                        {service.stats.map((stat, idx) => (
                          <div key={idx} className="text-center p-3 rounded-lg bg-gradient-to-br from-blue-50 to-orange-50 dark:from-gray-700 dark:to-gray-800">
                      ...
                      <div className="mb-6">
                        <div className="flex flex-wrap gap-2">
                          {service.features.map((feature, idx) => (
                            <span
                              key={idx}
                              className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 text-blue-700 dark:text-blue-300 px-3 py-1.5 rounded-full text-sm font-medium transform hover:scale-105 transition-transform duration-300"
                            >
                              {feature}
                            </span>
                          ))}
                      ...
                      <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-700">
                        <Button 
                          to={service.link} 
                          className="w-full group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-orange-500 group-hover:text-white group-hover:border-transparent transition-all duration-300 relative overflow-hidden"
                        >
          ...
          <div className="max-w-6xl mx-auto">
              ...
              {benefits.map((benefit, index) => (
                <AnimatedSection key={index} animation="scale" delay={index * 100}>
                  <div className="group relative">
                    ...
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100 dark:border-gray-700">
                      {/* Icon */}
            ...
            <AnimatedSection animation="fade-up" delay={600} className="mt-16">
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-blue-500/5 to-orange-500/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-gray-100 dark:border-gray-600">
                  <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      ...
                      <Button 
                        to="/projects" 
                        variant="outline"
                        className="border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white hover:scale-105 transition-all duration-300"
                      >
                        View Our Projects
                      </Button>
                    </div>
